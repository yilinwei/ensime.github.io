...
If you think you've found a bug you can file it at https://github.com/ensime/ensime-emacs/issues/new (you'd don't need to ask on the channel, just go right ahead and create a ticket).
